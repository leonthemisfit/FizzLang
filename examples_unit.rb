...
# Test Case for the KeywordBarBaz class
class TestKeywordBarBaz < Test::Unit::TestCase
    # Prepare +fb+ instance variable for use in tests
    def setup
        @kbb = KeywordBarBaz.new(1..15)
    end

    # Test the class methods on KeywordBarBaz
    def test_static
        assert_equal('1', KeywordBarBaz.check(1))
        assert_equal('Bar', KeywordBarBaz.check(3))
        assert_equal('Baz', KeywordBarBaz.check(5))
        assert_equal('BarBaz', KeywordBarBaz.check(15))
        assert_equal(3, KeywordBarBaz.bar)
        assert_equal(5, KeywordBarBaz.baz)
        assert_equal(['1', '2', 'Bar'], KeywordBarBaz.check_range(1..3))

        assert_equal('Bar', KeywordBarBaz.bar_string)
        assert_equal('Baz', KeywordBarBaz.baz_string)
    end
...
# Test Case for the BlockBarBaz class
class TestBlockBarBaz < Test::Unit::TestCase
    # Prepare +fb+ instance variable for use in tests
    def setup
        @bbb = BlockBarBaz.new(1..15)
    end

    # Test the class methods on BlockBarBaz
    def test_static
        assert_equal('1', BlockBarBaz.check(1))
        assert_equal('Bar', BlockBarBaz.check(3))
        assert_equal('Baz', BlockBarBaz.check(5))
        assert_equal('BarBaz', BlockBarBaz.check(15))
        assert_equal(3, BlockBarBaz.bar)
        assert_equal(5, BlockBarBaz.baz)
        assert_equal(['1', '2', 'Bar'], BlockBarBaz.check_range(1..3))

        assert_equal('Bar', BlockBarBaz.bar_string)
        assert_equal('Baz', BlockBarBaz.baz_string)
    end
    ...
    def test_select
        assert_equal(['Bar', 'Bar', 'Bar', 'Bar'], @bbb.select { |res| res == 'Bar' })
        assert_equal(['Baz', 'Baz'], @bbb.select { |res| res == 'Baz' })
